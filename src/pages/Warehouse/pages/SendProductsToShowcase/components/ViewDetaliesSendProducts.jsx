...
export default function ViewDetaliesSendProducts() {
  ...
  const { data: warehousesData, isLoading: warehousesLoading } = useFetch(
    "warehouse",
    "warehouse",
    {}
  );
  ...
  useEffect(() => {
    if (warehousesData?.data?.warehouses && name) {
      const foundWarehouse = warehousesData?.data?.warehouses?.find(
    ...
    >
      ...
      <div className="relative z-0 max-w-[1440px] mx-auto flex flex-col items-center justify-center mt-[120px]">
        <SearchForm
          ...
          name={name + "iga"}
          title="Омборидиги маҳсулотларни витринага юбориш"
